...
get_ipython().magic('pwd ')
lhew.shape
lh_labels = npy.load("LH_clustering_labels.npy")
plt.scatter(lhew[:,0],lhew[:,1],c=lh_labels,s=400)
plt.colorbar()
plt.show()
get_ipython().magic('ls ')
lhi
...
get_ipython().magic('cd Subject1/')
get_ipython().magic('ls ')
shutil.copy("File_List.npy","Interp_Segment_All/File_List_Meta.npy")
get_ipython().magic('ls ')
get_ipython().magic('cd Interp_Segment_All/')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('ls ')
for i in range(31):
    shutil.copy("Traj_{0}/Comp_Seg_Full/lh_seg_ind_ALL.npy".format(i),"Traj_{0}/Interp_Segment_All/LH_Segment_Ind.npy".format(i))
    
for i in range(31):
    shutil.copy("Traj_{0}/Comp_Seg_Full/rh_seg_ind_ALL.npy".format(i),"Traj_{0}/Interp_Segment_All/RH_Segment_Ind.npy".format(i))
    
for i in range(31):
    shutil.rmtree("Traj_{0}/Comp_Segment/".format(i))
    shutil.rmtree("Traj_{0}/Force_Segments/".format(i))
    shutil.rmtree("Traj_{0}/Interp_Oversegment/".format(i))
    
for i in range(31):
    shutil.rmtree("Traj_{0}/Interp_100_Basis/".format(i))
    
get_ipython().magic('ls ')
get_ipython().magic('rm -r Interp_Meta_100/')
get_ipython().magic('rm -r Interp_Meta_500/')
get_ipython().magic('ls ')
get_ipython().magic('rm -r Seg_30_can/')
get_ipython().magic('ls ')
get_ipython().magic('ls Meta/')
get_ipython().magic('ls ')
get_ipython().magic('rm -r Meta/')
get_ipython().magic('ls ')
get_ipython().magic('cd Clusters/')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('rm -r Clusters/')
get_ipython().magic('ls ')
get_ipython().magic('cd Files/')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('rm -r Files/')
get_ipython().magic('ls ')
get_ipython().magic('ls ')
get_ipython().magic('pwd ')
get_ipython().magic('cd Traj_1/')
get_ipython().magic('ls ')
get_ipython().magic('cd Segment_0/')
get_ipython().magic('ls ')
pos = npy.load("lh_pos.npy")
get_ipython().magic('cd ..')
get_ipython().magic('cd Segment_1')
pos1 = npy.load("lh_pos.npy")
pos1.shape
pos.shape
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
...
get_ipython().magic('cd ..')
get_ipython().magic('ls ')
get_ipython().magic('cd Subject1_rgbd_images/')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('pwd ')
get_ipython().magic('cd ../../..')
get_ipython().magic('ls ')
get_ipython().magic('cd Action_Primitives_script_backup/')
get_ipython().magic('ls ')
get_ipython().magic('mv Primitive_Library/* IMPORTANT_DATA_BACKUP/')
get_ipython().magic('ls ')
get_ipython().magic('cd IMPORTANT_DATA_BACKUP/')
get_ipython().magic('ls ')
get_ipython().magic('cd Subject1/')
get_ipython().magic('ls ')
get_ipython().magic('cd Files/')
...
get_ipython().magic('cd ..')
get_ipython().magic('ls ')
get_ipython().magic('cd Primitive_Library/')
get_ipython().magic('ls ')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('rm -r Primitive_Library/')
get_ipython().magic('ls ')
get_ipython().magic('cd Segmentation/')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('cd Untitled\\ Folder')
get_ipython().magic('ls ')
get_ipython().magic('cd ..')
get_ipython().magic('ls ')
get_ipython().magic('cd Data/')
...
get_ipython().magic('cd ..')
get_ipython().magic('ls ')
get_ipython().magic('cd ActionPrimitives/')
get_ipython().magic('ls ')
get_ipython().magic('ls ')
get_ipython().magic('cd Data/')
get_ipython().magic('ls ')
get_ipython().magic('cd Cornell_Data/')
get_ipython().magic('ls ')
get_ipython().magic('cd Subject1_rgbd_images/')
get_ipython().magic('ls ')
get_ipython().magic('cd Interp_Segment_All/')
...
get_ipython().magic('ls ')
for i in range(1):
    shutil.rmtree("Traj_{0}/Segment_*".format(i))
...
get_ipython().magic('ls ')
for i in range(1):
    shutil.rmtree("Traj_{0}/Segment_{1}/".format(i,'*'))
...
import subprocess
for i in range(1,31):
    command="git rm -r Traj_{0}/Segment_*/".format(i)
...
get_ipython().magic('pwd ')
get_ipython().magic('ls ')
get_ipython().magic('pinfo subprocess.call')
"Traj_{0}/Segment_[0-9]"
"Traj_{0}/Segment_[0-9]".format(i)
get_ipython().magic('save META.py 1-612')
