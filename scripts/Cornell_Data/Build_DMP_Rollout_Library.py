...
for i in range(0,number_trajectories):
	for j in range(0,int(number_segments[i])):
		...
		command = "./scripts/Cornell_Data/DMP_Rollout_3D.py Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/lh_pos.npy Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/lh_vel.npy Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/lh_acc.npy".format(i,j)
		subprocess.call(command.split(),shell=False)
		move_files(i,j)
...
for i in range(0,number_trajectories):
	for j in range(0,int(number_segments[i])):
		...
		command = "./scripts/Cornell_Data/DMP_Rollout_3D.py Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/rh_pos.npy Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/rh_vel.npy Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Segment_{1}/rh_acc.npy".format(i,j)
		subprocess.call(command.split(),shell=False)
		move_files(i,j)
