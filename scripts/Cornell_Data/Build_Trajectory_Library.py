...
def move_files(i):	
	shutil.move("force_weights.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/lh_force_weights.npy".format(i))	
	shutil.move("roll_pos.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/lh_roll_pos.npy".format(i))
	shutil.move("roll_vel.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/lh_roll_vel.npy".format(i))	
	shutil.move("roll_acc.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/lh_roll_acc.npy".format(i))
...
def move_files(i):	
	shutil.move("force_weights.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/rh_force_weights.npy".format(i))	
	shutil.move("roll_pos.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/rh_roll_pos.npy".format(i))
	shutil.move("roll_vel.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/rh_roll_vel.npy".format(i))	
	shutil.move("roll_acc.npy","Data/Cornell_Data/Primitive_Library/Subject1/Traj_{0}/Comp_Seg_Full/rh_roll_acc.npy".format(i))
