...
# NORMALIZED TRAJECTORIES AND ROLLOUTS:
for i in range(0,number_trajectories):
	for j in range(0,number_segments):

		pos = npy.load("Data/Mouse_Overlap/Traj_{0}/Segment_{1}/pos.npy".format(i,j))
		dmp_pos = npy.load("Data/Mouse_Overlap/Traj_{0}/Segment_{1}/roll_pos.npy".format(i,j))
