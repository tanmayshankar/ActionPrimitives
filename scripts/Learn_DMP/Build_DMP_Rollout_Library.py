...
def move_files(i,j):
	...
	shutil.move("roll_pos.npy","Data/Mouse_Data/Scaled_Goal/Traj_{0}/roll_pos_{1}.npy".format(i,j))
	shutil.move("roll_vel.npy","Data/Mouse_Data/Scaled_Goal/Traj_{0}/roll_vel_{1}.npy".format(i,j))	
	shutil.move("roll_acc.npy","Data/Mouse_Data/Scaled_Goal/Traj_{0}/roll_acc_{1}.npy".format(i,j))
	shutil.move("roll_force.npy","Data/Mouse_Data/Scaled_Goal/Traj_{0}/roll_force_{1}.npy".format(i,j))

for i in range(0,number_trajectories):
	for j in range(0,number_segments):

		print("The Counter is :",i,j)
		command = "./scripts/Learn_DMP/Rollout_Trajectories.py Data/Mouse_Data/Traj_{0}/position_{1}.npy Data/Mouse_Data/Traj_{0}/velocity_{1}.npy Data/Mouse_Data/Traj_{0}/acceleration_{1}.npy".format(i,j)	
